...
$(function () {
    ...
    $(".comment_form").submit(function (e) {
        ...
        let news_comment = $(".comment_input").val();
    ...
    $('.comment_list_con').delegate('a,input', 'click', function () {
        ...
        if (sHandler.indexOf('comment_up') >= 0) {
            ...
            $.ajax({
                ...
                success: function (resp) {
                    if (resp.errno == "0") {
                        // 更新点赞按钮图标
                        let like_count = $this.attr('data-likecount');
        ...
        if (sHandler.indexOf('reply_sub') >= 0) {
            let $this = $(this);
            let news_id = $this.parent().attr('data-newsid');
            let parent_id = $this.parent().attr('data-commentid');
